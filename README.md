...
Teams that use OpenClaw can add
[TweetClaw](https://github.com/Xquik-dev/tweetclaw) as a public X/Twitter signal
source:
...
See [docs/tweetclaw-x-source.md](docs/tweetclaw-x-source.md) for the full setup
and workflow.
